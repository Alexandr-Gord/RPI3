...
function TimelineBlock(props) {
    return (
        <Timeline lineColor={'#ddd'}>
            ...
            <TimelineItem
                key="005"
                dateText={props.biography.biography[4].date}
                style={{color: '#e86971'}}
            >
                <h3>{props.biography.biography[4].description}</h3>
            </TimelineItem>
            <TimelineItem
                key="005"
                dateText={props.biography.biography[5].date}
                style={{color: '#e86971'}}
            >
                <h3>{props.biography.biography[5].description}</h3>
            </TimelineItem>
        </Timeline>
    );
}
